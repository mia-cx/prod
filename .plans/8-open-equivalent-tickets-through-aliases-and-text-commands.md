...
- Seam validation: `pnpm --filter @prod/app test` (209/209, with `--config.verify-deps-before-run=false` — the preflight needs a TTY in this environment), typecheck, and lint all passed.
